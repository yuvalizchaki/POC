                            ...
                            b1.OwnsOne("POC.Infrastructure.Models.DisplayConfig", "DisplayConfig", b2 =>
                                {
                                    ...
                                    b2.Property<int?>("PagingRefreshTime")
                                        .HasColumnType("integer");
                            ...
                            b1.OwnsOne("POC.Infrastructure.Models.OrderFiltering", "OrderFiltering", b2 =>
                                {
                                    ...
                                    b2.OwnsOne("POC.Infrastructure.Models.TimeEncapsulated", "TimeRanges", b3 =>
                                        {
                                            b3.Property<int>("OrderFilteringScreenProfileFilteringScreenProfileId")
                                                .HasColumnType("integer");

                                            b3.Property<int>("Include")
                                                .HasColumnType("integer");
                                            ...
                                            b3.OwnsOne("POC.Infrastructure.Common.utils.TimeRangePart", "From", b4 =>
                                                {
                                                    b4.Property<int>("TimeEncapsulatedOrderFilteringScreenProfileFilteringScreenProfileId")
                                                        .HasColumnType("integer")
                                                        .HasColumnName("TimeEncapsulatedOrderFilteringScreenProfileFilteringScreenProf~");

                                                    b4.Property<int>("Amount")
                                                        .HasColumnType("integer");

                                                    b4.Property<int>("Mode")
                                                        .HasColumnType("integer");

                                                    b4.Property<int>("Unit")
                                                        .HasColumnType("integer");

                                                    b4.HasKey("TimeEncapsulatedOrderFilteringScreenProfileFilteringScreenProfileId");

                                                    b4.ToTable("ScreenProfiles");

                                                    b4.WithOwner()
                                                        .HasForeignKey("TimeEncapsulatedOrderFilteringScreenProfileFilteringScreenProfileId");
                                                });

                                            b3.OwnsOne("POC.Infrastructure.Common.utils.TimeRangePart", "To", b4 =>
                                                {
                                                    b4.Property<int>("TimeEncapsulatedOrderFilteringScreenProfileFilteringScreenProfileId")
                                                        .HasColumnType("integer")
                                                        .HasColumnName("TimeEncapsulatedOrderFilteringScreenProfileFilteringScreenProf~");
