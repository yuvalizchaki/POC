        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScreenProfileFiltering_OrderFiltering_TimeRanges_From_Unit = table.Column<int>(type: "integer", nullable: true),
                    ScreenProfileFiltering_OrderFiltering_TimeRanges_From_Mode = table.Column<int>(type: "integer", nullable: true),
                    ScreenProfileFiltering_OrderFiltering_TimeRanges_From_Amount = table.Column<int>(type: "integer", nullable: true),
                    ScreenProfileFiltering_OrderFiltering_TimeRanges_To_Unit = table.Column<int>(type: "integer", nullable: true),
                    ScreenProfileFiltering_OrderFiltering_TimeRanges_To_Mode = table.Column<int>(type: "integer", nullable: true),
                    ScreenProfileFiltering_OrderFiltering_TimeRanges_To_Amount = table.Column<int>(type: "integer", nullable: true),
                    ScreenProfileFiltering_OrderFiltering_TimeRanges_Include = table.Column<int>(type: "integer", nullable: false),
                    ...
                    ScreenProfileFiltering_InventorySorting = table.Column<List<string>>(type: "text[]", nullable: true),
                    ...
                    ScreenProfileFiltering_DisplayConfig_Label = table.Column<string>(type: "text", nullable: true),
                    ScreenProfileFiltering_DisplayConfig_PagingRefreshTime = table.Column<int>(type: "integer", nullable: true),
                    ScreenProfileFiltering_DisplayConfig_IsDarkMode = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
